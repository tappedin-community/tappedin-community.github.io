<%--
  editwelcome.jsp
  ---------------
  The edit page for the welcome text in the Tapped In 2 Course Manager 
  sketch.
...
<% final String filename = "editwelcome.jsp"; %>
<% final String pagename = "Settings: Room Configuration: Edit Welcome Text"; %>
        ...
        <tr valign=top>
          ...
          <td>
            <p><font size=-1>
              ...
              Edit Welcome Text</font></p>
            <h2 align=center>Edit Welcome Text</h2>
            <form method=post 
                  action="<%= fromPage %>" 
                  name="editWelcomeTextForm">
            <h3>Welcome Text</h3>
            <textarea rows=6 cols=60>CS 101 is an introductory course taught by Patti Schank about programming in the language of C.  See the <a href="info.jsp">Course Information</a> for a complete description of the course content.</textarea>
            <div align=center>
