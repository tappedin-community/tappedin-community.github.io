<%--
  links.jsp
  ---------
  The links page of the Tapped In 2 Course Manager sketch.
...
<% final String filename = "links.jsp"; %>
<% final String pagename = "Course Materials: Links"; %>
      ...
      <table width="100%">
        <tr valign=top>
          ...
          <td>
            ...
            <p>Links for CS 101</p>
            <p>You can:</p>
            <ul>
              <li>view links</li>
              <% if (user.equals("Patti")) { %>
              <li>add/delete/edit links</li>
              <% } %>
            </ul>
          </td>
        </tr>
