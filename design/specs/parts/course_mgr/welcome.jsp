        ...
        <tr valign=top>
          ...
          <td>
            ...
            <p>CS 101 is an introductory course taught by Patti Schank about
              ...
              <font size=-1><a href="editwelcome.jsp?frompage=welcome.jsp">edit</a></font>
              <% } %>
              </p>
            <table cellpadding=5>
              <tr valign=top>
                  ...
                  <table border=1 bgcolor="white" cellspacing=0>
                    <tr bgcolor="yellow">
                      ...
                      <td align=right width=20>
                        <font size=-1><a href="editannounce.jsp?frompage=welcome.jsp">edit</a></font>
                      </td>
                    ...
                    <tr>
                      ...
                      <% } %>
                        <ul>
                          <li>12/12/01 We're moving the subnavigation to the 
